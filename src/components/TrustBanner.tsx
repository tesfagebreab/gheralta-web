...
export default function TrustBanner({ data, brand }: TrustBannerProps) {
  ...
  return (
    <section className="bg-stone-50 py-16 md:py-24 text-stone-900 overflow-hidden rounded-[2.5rem] md:rounded-[4rem] my-8 md:my-12 mx-4 md:mx-0 border border-stone-200 shadow-xl">
      <div className="max-w-6xl mx-auto px-6">
        
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-16 items-center mb-16 md:mb-20">
          {/* Text Content */}
          <div className="lg:col-span-7 order-2 lg:order-1">
            <h2 className="text-3xl md:text-6xl font-black italic tracking-tighter leading-[1] md:leading-[0.9] mb-6 md:mb-8 uppercase text-stone-900">
              {headline}
            </h2>
            ...
            <div className="flex gap-8 md:gap-12 mt-8 md:mt-10">
              ...
              <div>
                ...
                <p className="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-stone-400 mt-1">Years Excellence</p>
              </div>
              ...
              <div>
                ...
                <p className="text-[9px] md:text-[10px] font-black uppercase tracking-widest text-stone-400 mt-1">
                  {clientText}
                </p>
              </div>
            </div>
          ...
          <div className="lg:col-span-5 relative order-1 lg:order-2">
            <div className="relative z-10 rounded-[2rem] md:rounded-[3rem] overflow-hidden border-4 md:border-8 border-white aspect-[4/5] shadow-2xl bg-stone-200">
              {founderImgUrl ? (
                <Image 
                  src={founderImgUrl}
                  alt="Founder"
            ...
            {/* Dynamic Shadow Decoration */}
            <div 
              className="absolute -bottom-4 -right-4 md:-bottom-6 md:-right-6 w-full h-full rounded-[2rem] md:rounded-[3rem] opacity-10 -z-0"
        ...
        <div className="pt-12 md:pt-16 border-t border-stone-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-10 md:gap-12">
            
            {/* Trust Badges */}
            <div className="flex flex-wrap justify-center gap-6 md:gap-8 opacity-60 grayscale hover:opacity-100 hover:grayscale-0 transition-all duration-500">
            ...
            <div className="flex flex-wrap justify-center gap-6 md:gap-10">
              {safeMap(logos).map((logo: any, idx: number) => {
                ...
                return (
                  <div key={logo.id || `logo-${idx}`} className="relative h-6 w-24 md:h-8 md:w-28 opacity-40 hover:opacity-100 transition-opacity">
                     <Image 
                      src={logoUrl} 
                      alt="Partner Logo" 
                      fill 
